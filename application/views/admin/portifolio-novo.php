...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="container">
            <div class="col-md-12">
                <h3><i class="fa fa-file-image-o"></i> Novo Item
            ...
            <form action="<?= base_url()?>gravar-portifolio" method="post" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="portifolio_titulo" class="form-control" id="portifolio_titulo" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="portifolio_subtitulo" class="form-control" id="portifolio_subtitulo">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="portifolio_link" class="form-control" id="portifolio_link">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="portifolio_categoria" class="form-control" id="portifolio_categoria" required>
                    </div>
                </div>
                <div class="row"></div><br>
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="portifolio_descricao" id="portifolio_descricao" class="summernote"></textarea>
                </div>
                <div class="row"></div><br>
