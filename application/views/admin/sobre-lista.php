...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="container">
            <div class="col-md-12">
                <h3><i class="fa fa-question-circle"></i> Sobre
                    <a href='<?= base_url()?>novo-sobre' class="btn btn-custom pull-right waves-effect waves-light"><i class="fa fa-user-plus"></i> Adicionar Novo</a></h3>
            </div>
            <hr class="divisor">
            <br>
            <table id="datatable" class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th class="text-uppercase text-center" ><strong>Subtítulo</strong></th>
                ...
                <?php foreach($sobre as $s): ?>
                    <tr id="registro_tr_<?= $s['sobre_id']?>">
                        ...
                        <td class="text-center"><?= $s['sobre_titulo']?></td>
                        <td class="text-center"><?= $s['sobre_subtitulo']?></td>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-danger btn-rounded btn-small waves-effect waves-light remove-registro" data-toggle="modal" data-target=".modal-remove" data-id="<?=$s['sobre_id']?>"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
...
<script src="<?= base_url('app-js/admin/sobre.js')?>"></script>
<script>
    $('#datatable').DataTable({
        "language": {
