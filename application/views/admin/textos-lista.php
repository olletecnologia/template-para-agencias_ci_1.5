            ...
            <div class="row">
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" maxlength="45" name="texto_titulo" id="texto_titulo" value="<?= $texto['texto_titulo']?>">
                    </div>
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" maxlength="45" name="texto_subtitulo" id="texto_subtitulo" value="<?= $texto['texto_subtitulo']?>">
                    </div>
                    <div class="col-md-2" style="display: flex; align-items: flex-end">
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" maxlength="45" name="texto_botao_topo" id="texto_botao_topo" value="<?= $texto['texto_botao_topo']?>">
                    </div>
                    <div class="col-md-2" style="display: flex; align-items: flex-end">
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" maxlength="45" name="texto_servico" id="texto_servico" value="<?= $texto['texto_servico']?>">
                    </div>
                    <div class="col-md-2" style="display: flex; align-items: flex-end">
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" maxlength="45" name="texto_sub_servico" id="texto_sub_servico" value="<?= $texto['texto_sub_servico']?>">
                    </div>
                    <div class="col-md-2" style="display: flex; align-items: flex-end">
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" maxlength="45" name="texto_portifolio" id="texto_portifolio" value="<?= $texto['texto_portifolio']?>">
                    </div>
                    <div class="col-md-2" style="display: flex; align-items: flex-end">
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" maxlength="45" name="texto_sub_portifolio" id="texto_sub_portifolio" value="<?= $texto['texto_sub_portifolio']?>">
                    </div>
                    <div class="col-md-2" style="display: flex; align-items: flex-end">
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" maxlength="45" name="texto_sobre" id="texto_sobre" value="<?= $texto['texto_sobre']?>">
                    </div>
                    <div class="col-md-2" style="display: flex; align-items: flex-end">
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" maxlength="45" name="texto_sub_sobre" id="texto_sub_sobre" value="<?= $texto['texto_sub_sobre']?>">
                    </div>
                    <div class="col-md-2" style="display: flex; align-items: flex-end">
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        <label for="texto_sobre_final">Final do Sobre</label>
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" maxlength="45" name="texto_equipe" id="texto_equipe" value="<?= $texto['texto_equipe']?>" >
                    </div>
                    <div class="col-md-2" style="display: flex; align-items: flex-end">
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" maxlength="45" name="texto_sub_equipe" id="texto_sub_equipe" value="<?= $texto['texto_sub_equipe']?>" >
                    </div>
                    <div class="col-md-2" style="display: flex; align-items: flex-end">
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" maxlength="45" name="texto_contato" id="texto_contato" value="<?= $texto['texto_contato']?>">
                    </div>
                    <div class="col-md-2" style="display: flex; align-items: flex-end">
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" maxlength="45" name="texto_sub_contato" id="texto_sub_contato" value="<?= $texto['texto_sub_contato']?>">
                    </div>
                    <div class="col-md-2" style="display: flex; align-items: flex-end">
                ...
                <div style="display: flex; justify-content: center">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" maxlength="45" name="texto_botao_mensagem" id="texto_botao_mensagem" value="<?= $texto['texto_botao_mensagem']?>">
                    </div>
                    <div class="col-md-2" style="display: flex; align-items: flex-end">
